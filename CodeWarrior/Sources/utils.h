...
#define LO_NYBBLE(value)	((value) & 0x0F)		// Get lower nybble of byte
#define HI_NYBBLE(value)	(((value) & 0x0F) >> 4) // Get upper nybble of byte
=======
>>>>>>> 87b9f85348c8b4d7529b01292f217b9bdb71c7de
